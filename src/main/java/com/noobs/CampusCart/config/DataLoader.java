...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User admin = new User(null, "admin", "admin@mail.com", "very very admin", "01710000000",
        ...
        User u6 = new User(null, "asdf", "asdf@mail.com", "asdf asdf", "01710000006", passwordEncoder.encode("asdf"),
        ...
        // ----- Products -----
        Product p1 = new Product(null, "Laptop", 500.0, "Good", "/images/laptop.jpg", "sell", u1.getId(), c1.getId(),
                null, null);
        Product p2 = new Product(null, "Smartphone", 300.0, "Fair", "/images/smartphone.jpg", "sell", u2.getId(),
                c1.getId(), null, null);
        Product p3 = new Product(null, "Data Structures Book", 25.0, "Good", "ds_book.jpg", "rent", u3.getId(),
                c2.getId(), null, null);
        Product p4 = new Product(null, "Desk Chair", 40.0, "Good", "chair.jpg", "sell", u1.getId(), c3.getId(), null,
                null);
        Product p5 = new Product(null, "Dining Table", 120.0, "Fair", "table.jpg", "sell", u2.getId(), c3.getId(), null,
                null);
        Product p6 = new Product(null, "Calculus Book", 20.0, "Good", "calc_book.jpg", "rent", u3.getId(), c2.getId(),
                null, null);
        Product p7 = new Product(null, "Headphones", 60.0, "Good", "headphones.jpg", "sell", u4.getId(), c1.getId(),
                null, null);
        Product p8 = new Product(null, "Bed Frame", 150.0, "Fair", "bed.jpg", "sell", u5.getId(), c3.getId(), null,
                null);
        Product p9 = new Product(null, "Novel: The Alchemist", 15.0, "Good", "alchemist.jpg", "rent", u3.getId(),
                c2.getId(), null, null);
        Product p10 = new Product(null, "Monitor", 200.0, "Good", "monitor.jpg", "sell", u1.getId(), c1.getId(), null,
                null);

        Product p11 = new Product(null, "Notebook Set", 15.0, "New", "notebook_set.jpg", "sell", u1.getId(), c4.getId(),
                null, null);
        Product p12 = new Product(null, "Pen Pack", 5.0, "New", "pen_pack.jpg", "sell", u2.getId(), c4.getId(), null,
                null);
        Product p17 = new Product(null, "Highlighter Set", 7.0, "New", "highlighter_set.jpg", "sell", u5.getId(),
                c4.getId(), null, null);
        Product p18 = new Product(null, "Sticky Notes", 3.0, "New", "sticky_notes.jpg", "sell", u1.getId(), c4.getId(),
                null, null);

        Product p13 = new Product(null, "Football", 25.0, "Good", "football.jpg", "sell", u4.getId(), c5.getId(), null,
                null);
        Product p14 = new Product(null, "Badminton Set", 40.0, "Like New", "badminton_set.jpg", "sell", u6.getId(),
                c5.getId(), null, null);
        Product p19 = new Product(null, "Yoga Mat", 18.0, "New", "yoga_mat.jpg", "sell", u3.getId(), c5.getId(), null,
                null);
        Product p20 = new Product(null, "Tennis Racket", 50.0, "Good", "tennis_racket.jpg", "sell", u4.getId(),
                c5.getId(), null, null);

        Product p15 = new Product(null, "Bed Sheet", 20.0, "New", "bed_sheet.jpg", "sell", u6.getId(), c6.getId(), null,
                null);
        Product p16 = new Product(null, "Desk Lamp", 12.0, "Good", "desk_lamp.jpg", "sell", u4.getId(), c6.getId(),
                null, null);
        Product p21 = new Product(null, "Pillow Set", 15.0, "New", "pillow_set.jpg", "sell", u1.getId(), c6.getId(),
                null, null);
